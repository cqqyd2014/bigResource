...
public interface HbaseOperations {
	...
	List<RegionInfo> getRegionsByServerName(String serverName) throws IOException ;
	List<RegionInfo> getRegionsByTableName(String tableName) throws IOException;
	...
	void createTable(String tableName,String columnFamliy) throws IOException;
	void createTableWithRegions(String tableName,String columnFamliy,String startKey,String endKey,int numRegions) throws IOException;
}