...
public class HbaseTemplate extends HbaseAccessor implements HbaseOperations {
	...
	public HbaseTemplate(Connection configuration) throws IOException {
	...
	@Override
	public void createTable(String tableName, String columnFamliy) throws IOException {
		// TODO Auto-generated method stub
		TableDescriptor tableDesc = TableDescriptorBuilder.newBuilder(TableName.valueOf(tableName))
                .setColumnFamily(ColumnFamilyDescriptorBuilder.newBuilder(Bytes.toBytes(columnFamliy)).build())
                
                .build();
		getAdmin().createTable(tableDesc);
	...
	@Override
	public void createTableWithRegions(String tableName, String columnFamliy,String startKey,String endKey,int numRegions) throws IOException{
		// TODO Auto-generated method stub
		TableDescriptor tableDesc = TableDescriptorBuilder.newBuilder(TableName.valueOf(tableName))
                .setColumnFamily(ColumnFamilyDescriptorBuilder.newBuilder(Bytes.toBytes(columnFamliy)).build())
                
                .build();
		getAdmin().createTable(tableDesc,Bytes.toBytes(startKey),Bytes.toBytes(endKey),numRegions);
	}
	...
	public List<ServerName> listDeadServers() throws IOException {
		// TODO Auto-generated method stub
		return getAdmin().listDeadServers();
	}
	...
	public ServerName getMaster() throws IOException {
		// TODO Auto-generated method stub
		return getAdmin().getMaster();
	}

	@Override
	public List<RegionInfo> getRegionsByServerName(String serverName) throws IOException {
		// TODO Auto-generated method stub
		return getAdmin().getRegions(ServerName.valueOf(serverName));
	}

	@Override
	public List<RegionInfo> getRegionsByTableName(String tableName) throws IOException {
		// TODO Auto-generated method stub
		return getAdmin().getRegions(TableName.valueOf(tableName));
	}
