...
public class TestApp {
	/*
	 * @Resource(name="hbaseNodePersonImpl") //实现类1中 @Service注解中标定的名称 private
	 * HbaseTableOperationAbs<NodePerson> nodePersonImpl;
	 *
	 * @Autowired private Connection hConn;
	 *
	 * @Autowired private ManualConfig mConfig;
	 */
     ...
     public void testSome() {
		 ...
		 */
		 ...
		 cSVImporter.readTemplate("D:/1.json"); 
